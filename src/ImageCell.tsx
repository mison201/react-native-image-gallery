...
export class ImageCell extends React.Component<ImageCellProps, ImageCellState> {
    ...
    shouldComponentUpdate(
        nextProps: ImageCellProps,
        nextState: ImageCellState
    ): boolean {
        const { shouldHideDisplayedImage } = this.props;
        const { imageLoaded } = this.state;

        if (
            shouldHideDisplayedImage !== nextProps.shouldHideDisplayedImage ||
    ...
    componentDidUpdate(
        prevProps: ImageCellProps,
        prevState: ImageCellState
    ): void {
    ...
    measurePhoto = async () => {
        ...
        if (!this.imageRef || !this.readyToMeasure) {
            console.warn(
                "measurePhoto: Trying to measure image without ref or layout"
            );
        }
